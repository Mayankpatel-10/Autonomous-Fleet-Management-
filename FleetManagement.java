...
public class FleetManagement {
    private static final String URL = "jdbc:mysql://localhost:3306/autonomous_fleet";
    ...
    public static void main(String[] args) {
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD)) {
            ...
            while (true) {
                ...
                switch (choice) {
                    case 1: addVehicle(conn, scanner); break;
                    case 2: viewAllVehicles(conn); break;
                    case 3: updateVehicleStatus(conn, scanner); break;
                    case 4: viewMaintenanceHistory(conn, scanner); break;
                    case 5: scheduleMaintenance(conn, scanner); break;
